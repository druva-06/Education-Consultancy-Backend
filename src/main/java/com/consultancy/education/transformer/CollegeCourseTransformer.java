...
public class CollegeCourseTransformer {
    ...
    public static CollegeCourse excelToEntity(CollegeCourseRequestExcelDto collegeCourseRequestExcelDto) {
        return CollegeCourse.builder()
                ...
                .tuitionFee(FormatConverter.cnvrtCurrencyToDouble(collegeCourseRequestExcelDto.getTuitionFee()))
                ...
                .min10thScore(FormatConverter.cnvrtPercentageToDouble(collegeCourseRequestExcelDto.getMin10thScore()))
                .minInterScore(FormatConverter.cnvrtPercentageToDouble(collegeCourseRequestExcelDto.getMinInterScore()))
                .minGraduationScore(FormatConverter.cnvrtPercentageToDouble(collegeCourseRequestExcelDto.getMinGraduationScore()))
